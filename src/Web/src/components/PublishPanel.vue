...
const groups = computed(() =>
  publishStore.groupEntries(entriesStore.entries, projectsStore.projects, itemsById.value),
);
  ...
  <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
    ...
    <div class="mb-4 grid grid-cols-1 gap-2 md:grid-cols-2">
      ...
      <div class="text-xs text-slate-500 self-end">
        ...
        <span class="font-medium">Settings</span> page.
      </div>
    </div>
    ...
    <Message v-if="hasOpenProjectGroup" severity="info" class="mt-4" :closable="false">
