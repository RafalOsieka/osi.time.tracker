...
| 5.9      | Rounding rule applied on export                       | 🔴       | Configured per RemoteSystemConfig; applied once to the **selected-entry** total as the default export duration (user override retained until reset). Zero duration or empty selection excludes the task                                                               |
