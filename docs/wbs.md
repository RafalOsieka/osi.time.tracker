...
| **Tracker**        | A named remote issue-tracker connection (system type, base URL, execution mode, rounding). Browser-only API secret is never persisted server-side.                                                                                                                                                                               |
...
| #   | Feature                                       | Priority | Notes                                                                                                                                                                                                   |
| --- | --------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 5.1 | Create / edit / soft-delete Tracker           | 🔴       | Name + system type (redmine/openproject), base URL, adapter execution mode, rounding rule. Browser-only API secret                                                                                      |
