...
| **Tracker**        | A named remote issue-tracker connection (system type, base URL, execution mode, rounding, defaults). Browser-only API secret is never persisted server-side.                                                                                                                                                                     |
...
| #   | Feature                                                        | Priority | Notes                                                                                                                                                                                                                                               |
| --- | -------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3.1 | Create / edit / delete Tracker                                 | 🔴       | Named remote connection (system type, URL, execution mode, rounding, browser secret)                                                                                                                                                                |
| 3.2 | Create / edit / delete Project                                 | 🔴       | Optional Tracker parent; local projects allowed                                                                                                                                                                                                     |
...
| #   | Feature                                       | Priority | Notes                                                                                                                                                                                                   |
| --- | --------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 5.1 | Create / edit / soft-delete Tracker           | 🔴       | Name + system type (redmine/openproject), base URL, adapter execution mode, rounding rule, optional required-field defaults. Browser-only API secret                                                    |
| 5.2 | Adapter execution mode: server (proxied)      | 🔴       | Browser sends per-request secret to OSI server; server forwards to tracker and never persists the secret                                                                                                |
| 5.3 | Adapter execution mode: client-side (browser) | 🔴       | API calls made directly from the browser; for remote systems behind a VPN the user is already connected to. Credentials are entered and held only in the browser; never persisted server-side           |
...
| #        | Feature                                               | Priority | Notes                                                                                                                                                                                                                                                                 |
| -------- | ----------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 5.8      | Remote Sync page (day-level export)                   | 🔴       | Day-scoped page from the Timer view listing that day's tasks with entry selection, export duration, required fields, remote-log context, and batch export. Browser orchestrates remote create + local finalization; direct and Nitro-proxied transports are supported |
...
| #    | Feature                                                  | Priority | Notes                                                                                                                                                                                                                                   |
| ---- | -------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 5.14 | OpenProject adapter (fetch issues + export time entries) | 🔴       | MVP adapter. Shared transport-agnostic core plus direct browser and authenticated Nitro proxy transports for account resolution, activities, paginated time-log context, and time-entry create; browser remains the export orchestrator |
