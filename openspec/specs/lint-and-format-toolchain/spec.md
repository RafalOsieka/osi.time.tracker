...
The Oxlint configuration used by `pnpm lint` SHALL load the vendored anti-slop JS plugin and SHALL set every generic anti-slop rule to `error`. Effect-specific anti-slop rules SHALL NOT be enabled.
