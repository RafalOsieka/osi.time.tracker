...
### Requirement: REQ-NFR-010 Multi-stage production image build
...
### Requirement: REQ-NFR-011 Slim final runtime layer
...
### Requirement: REQ-NFR-014 Cross-compose network connectivity
...
### Requirement: REQ-NFR-015 Database migrations before serving traffic
