...
Defines requirements for a committed, reproducible local OpenProject instance — provided via a dedicated, opt-in Docker Compose file with built-in demo data — that developers can start on demand to build and test remote-tracker integration.
