...
- Default value for the configurable very-small timer-stack threshold. [UNCONFIRMED]
- Whether the icon-only rail enables tooltips by default for discoverability. [UNCONFIRMED]
