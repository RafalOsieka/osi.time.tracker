...
- `[CONFIRMED]` Exact `maxAge` value (proposal suggests ~1 week) — to be confirmed before implementation.
  - ANSWER: `1 week`
- `[CONFIRMED]` Whether `SameSite=Strict` is preferable to `Lax` for the target UX.
