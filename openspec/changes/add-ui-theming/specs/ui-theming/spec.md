...
### Requirement: REQ-NFR-021 Brand accent palette
...
- **THEN** the contrast ratio SHALL meet WCAG 2.1 AA (≥ 4.5:1 normal text, ≥ 3:1 large text / essential non-text UI), per REQ-NFR-019
...
### Requirement: REQ-NFR-022 Light/dark mode with system default and manual override
...
### Requirement: REQ-NFR-023 No flash of incorrect theme under SSR
...
### Requirement: REQ-NFR-025 Tokenized auth surface
...
## Open Questions
- **[RESOLVED]** Brand accent is the **cyan** family anchored at **`cyan.400`**, with the effective accent shade auto-selected per mode to satisfy AA; the exact ramp (50…950) and measured ratios are finalized during implementation (task 1.3).
