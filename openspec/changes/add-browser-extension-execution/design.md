...
- Package extraction is not yet landed -> apply only after migration verification; resolve imports against its public exports, not speculative source paths.

## Migration Plan

1. Land and verify the monorepo prerequisite.
